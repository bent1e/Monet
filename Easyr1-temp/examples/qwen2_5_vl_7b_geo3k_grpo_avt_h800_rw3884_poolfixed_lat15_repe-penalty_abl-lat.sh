...
python -m verl.trainer.main \
    ...
    trainer.experiment_name=AVTv5_rw-3884-1000-1000-poolfixed_latent${latent_size}_temp${TEMPERATURE}_tacc${SELECT_ACC_THRESHOLD}_rlsgm${AVT_RL_SIGMA}_APIjudge_lenPenalty${LENGTH_PENALTY_COEF}_use-lat-rwd_repe-penalty_abl-lat \
