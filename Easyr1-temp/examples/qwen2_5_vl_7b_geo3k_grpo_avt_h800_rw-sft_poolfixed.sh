...
MODEL_PATH=/mmu_vcg_ssd/shiyang06-temp/Latent_Think/checkpoint/avt_sft/10.7_sft_rw-doc-chart_ce2.0/checkpoint-3884
latent_size=8
...
python -m verl.trainer.main \
    ...
    trainer.experiment_name=AVTv5_rw-3884-sft-poolfixed_latent${latent_size}_temp${TEMPERATURE}_tacc${SELECT_ACC_THRESHOLD}_rlsgm${AVT_RL_SIGMA}_APIjudge_lenPenalty${LENGTH_PENALTY_COEF}_use-lat-rwd \
