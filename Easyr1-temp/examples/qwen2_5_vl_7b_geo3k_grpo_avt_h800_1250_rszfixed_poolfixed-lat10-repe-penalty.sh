...
MODEL_PATH=/mmu_vcg_ssd/shiyang06-temp/Latent_Think/checkpoint/avt_v5/10.21_v5_s2_rszfixed_imgrsz3000_mix_pt-sft1250_s1-pt-sft1250_teacher-al2.0-emph2.0-2250_latent8_ce4.0_align2.0/checkpoint-1250
latent_size=10
...
python -m verl.trainer.main \
    ...
    trainer.experiment_name=AVTv5_mix-1250-2250-1250-poolfixed_latent${latent_size}_temp${TEMPERATURE}_tacc${SELECT_ACC_THRESHOLD}_rlsgm${AVT_RL_SIGMA}_APIjudge_lenPenalty${LENGTH_PENALTY_COEF}_use-lat-rwd_repe-penalty \
