...
python -m verl.trainer.main \
    ...
    trainer.experiment_name=AVTv5_mix-1250-2250-1250-poolfixed_latent${latent_size}_temp${TEMPERATURE}_tacc${SELECT_ACC_THRESHOLD}_rlsgm${AVT_RL_SIGMA}_APIjudge_lenPenalty${LENGTH_PENALTY_COEF}_use-lat-rwd_abl-lat \
