...
1. Extract the answer from the [Model Response]. 
2. Assess the consistency of the extracted answer with the [Standard Answer] according to the [Question]. If the [Model Answer] is consistent with the [Standard Answer], please answer '1'. If not, or the answer for the [Question] cannot be extrated, answer '0'. Don't output any other information, just the number '0' or '1'.
