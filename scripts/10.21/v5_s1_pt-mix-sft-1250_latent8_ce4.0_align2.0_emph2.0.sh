...
SAVE_CKPT=10.21_v5_s1_mix_pt-sft-1250_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-wt${ALIGNMENT_WEIGHT}_emph-wt${EMPHASIZE_LATENT_WEIGHT}
...
torchrun --nproc-per-node=8 --master-port=29501 -m src.main \
  ...
  --task "mm-reasoning" \
  --stage "avt_v5_stage1" \
  --data_path "/ytech_m2v5_hdd/workspace/kling_mm/shiyang06/Dataset/abstract_visual/Visual_CoT/filtered_train_10.7.json" \
