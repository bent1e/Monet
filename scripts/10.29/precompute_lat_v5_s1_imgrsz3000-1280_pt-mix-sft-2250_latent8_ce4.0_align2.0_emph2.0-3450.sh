...
TEACHER=10.26_v5_s1-imgrsz3000-1280_mix_pt-sft-2250_latent8_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt${TEACHER_EMPHASIZE_LATENT_WEIGHT}/checkpoint-3450
