...
TEACHER_EMPHASIZE_LATENT_WEIGHT=1.0
TEACHER_ALIGN_WEIGHT=2.0
TEACHER=10.24_v5_s1-imgrsz3000-1280_mix_pt-sft-2250_latent8_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt${TEACHER_EMPHASIZE_LATENT_WEIGHT}/checkpoint-2500
...
TEACHER_EMPHASIZE_LATENT_WEIGHT=1.0
TEACHER_ALIGN_WEIGHT=2.0
TEACHER=10.24_v5_s1-imgrsz3000-1280_mix_pt-sft-2250_latent8_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt${TEACHER_EMPHASIZE_LATENT_WEIGHT}/checkpoint-2500torchrun --nproc-per-node=8 --master-port=29504 -m src.precompute_teacher_latents \
  --bsz 1 \
  --task "mm-reasoning" \
  --data_path \
...
TEACHER_EMPHASIZE_LATENT_WEIGHT=1.0
TEACHER_ALIGN_WEIGHT=2.0
TEACHER=10.24_v5_s1-imgrsz3000-1280_mix_pt-sft-2250_latent8_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt${TEACHER_EMPHASIZE_LATENT_WEIGHT}/checkpoint-2500torchrun --nproc-per-node=8 --master-port=29505 -m src.precompute_teacher_latents \
  --bsz 1 \
  --task "mm-reasoning" \
  --data_path \
