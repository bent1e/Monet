...
TEACHER=10.22_v5_s1_mix_pt-sft-1250_latent${LATENT_SIZE}_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt${TEACHER_EMPHASIZE_LATENT_WEIGHT}/checkpoint-2250

SAVE_CKPT=10.21_v5_s2_rszfixed_imgrsz3000_mix_pt-sft1250_s1-pt-sft1250_teacher-al${TEACHER_ALIGN_WEIGHT}-emph${TEACHER_EMPHASIZE_LATENT_WEIGHT}-2250_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
