...
SAVE_CKPT=10.21_v5_s2_imgrsz3000_mix_pt-sft1250_s1-pt-sft1250_teacher-al${TEACHER_ALIGN_WEIGHT}-emph${TEACHER_EMPHASIZE_LATENT_WEIGHT}-2250_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
