...
SAVE_CKPT=10.21_aux_v5_s2_imgrsz3000_mix_pt-sft1250_s1-pt-sft1250_teacher-al${TEACHER_ALIGN_WEIGHT}-emph${TEACHER_EMPHASIZE_LATENT_WEIGHT}-2250_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
...
torchrun --nproc-per-node=8 --master-port=29501 -m src.main \
  ...
  --data_path \
      ...
      "/ytech_m2v5_hdd/workspace/kling_mm/shiyang06/Dataset/abstract_visual/aux_data/aux_MME_235A20.json" \
