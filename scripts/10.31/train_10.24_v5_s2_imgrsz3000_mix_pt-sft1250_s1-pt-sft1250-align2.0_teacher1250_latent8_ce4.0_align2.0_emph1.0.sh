...
TEACHER=10.22_v5_s1_mix_pt-sft-1250_latent${LATENT_SIZE}_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt${TEACHER_EMPHASIZE_LATENT_WEIGHT}/checkpoint-1250

SAVE_CKPT=10.21_v5_s2_imgrsz3000_mix_pt-sft1250_s1-pt-sft1250_teacher-al${TEACHER_ALIGN_WEIGHT}-emph${TEACHER_EMPHASIZE_LATENT_WEIGHT}-1250_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
