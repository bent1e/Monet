...
TEACHER=10.15_v5_s1_rw_pt-sft_gc_latent8_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt${EMPHASIZE_LATENT_WEIGHT}/checkpoint-1000
...
SAVE_CKPT=10.16_v5_s2_rw_pt-sft3884_s1-pt-sft3884_teacher-al${TEACHER_ALIGN_WEIGHT}-emph${EMPHASIZE_LATENT_WEIGHT}-1000_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
