...
SAVE_CKPT=10.24_v5_s1-imgrsz3000-1280_mix_pt-sft-1250_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-wt${ALIGNMENT_WEIGHT}_emph-wt${EMPHASIZE_LATENT_WEIGHT}
