...
TEACHER=10.12_v5_stage1_pt_rw-doc-chart_4ep_gc_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-wt${ALIGNMENT_WEIGHT}_emph-wt${EMPHASIZE_LATENT_WEIGHT}/checkpoint-1500
...
SAVE_CKPT=10.14_v5_rw_pt-sft_stage1-pt-sft_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
