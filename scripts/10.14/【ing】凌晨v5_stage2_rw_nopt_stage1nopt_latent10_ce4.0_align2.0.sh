...
TEACHER=10.12_v5_stage1_nopt_rw_gc_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-wt${ALIGNMENT_WEIGHT}_emph-wt${EMPHASIZE_LATENT_WEIGHT}/checkpoint-1500
...
SAVE_CKPT=10.14_v5_rw_stage2_nopt_stage1nopt_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
