...
TEACHER=10.15_v5_s1_rw_pt-sft_gc_latent8_ce4.0_align-wt0.0_emph-wt2.0/checkpoint-1000
...
SAVE_CKPT=10.16_v5_s2_rw_pt-sft_s1-pt-sft_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
torchrun --nproc-per-node=8 --master-port=29501 -m src.main \
  ...
  --log_file "./log.txt" \
  --load_model_path /mmu_vcg_ssd/shiyang06-temp/Latent_Think/checkpoint/avt_v5/${SAVE_CKPT}/checkpoint-1500 \
