...
TEACHER=10.15_v5_s1_rw_pt-sft_gc_latent8_ce4.0_align-wt2.0_emph-wt2.0/checkpoint-2000
...
TEACHER=10.15_v5_s1_rw_pt-sft_gc_latent10_ce4.0_align-wt2.0_emph-wt2.0/checkpoint-2000
source /pfs/wangzihao11/miniconda3/bin/activate
conda activate mirage
cd /mmu_vcg_ssd/shiyang06-temp/Latent_Think/abstract-visual-token
export TOKENIZERS_PARALLELISM=false
...
TEACHER=10.15_v5_s1_rw_pt-sft_gc_latent12_ce4.0_align-wt2.0_emph-wt2.0/checkpoint-2000
source /pfs/wangzihao11/miniconda3/bin/activate
conda activate mirage
cd /mmu_vcg_ssd/shiyang06-temp/Latent_Think/abstract-visual-token
export TOKENIZERS_PARALLELISM=false
