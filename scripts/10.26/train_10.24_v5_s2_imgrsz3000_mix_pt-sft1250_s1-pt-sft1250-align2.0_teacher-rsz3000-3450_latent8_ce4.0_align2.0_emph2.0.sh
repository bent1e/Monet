...
TEACHER=10.24_v5_s1-imgrsz3000-1280_mix_pt-sft-1250_latent${LATENT_SIZE}_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt${TEACHER_EMPHASIZE_LATENT_WEIGHT}/checkpoint-3450

SAVE_CKPT=10.26_v5_s2_imgrsz3000_mix_pt-sft1250_s1-pt-sft1250_teacher-rsz3000-al${TEACHER_ALIGN_WEIGHT}-emph${TEACHER_EMPHASIZE_LATENT_WEIGHT}-3450_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
