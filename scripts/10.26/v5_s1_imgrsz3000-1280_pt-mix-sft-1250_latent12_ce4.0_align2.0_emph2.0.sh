...
TEACHER=10.19_sft_mix_ce2.0/checkpoint-1250

LATENT_SIZE=12
CE_EMPHASIZE_FACTOR=4.0
ALIGNMENT_WEIGHT=2.0
EMPHASIZE_LATENT_WEIGHT=2.0
SAVE_CKPT=10.26_v5_s1-imgrsz3000-1280_mix_pt-sft-1250_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-wt${ALIGNMENT_WEIGHT}_emph-wt${EMPHASIZE_LATENT_WEIGHT}
...
torchrun --nproc-per-node=8 --master-port=29502 -m src.main \
  --epochs 3 \
  --bsz 1 \
  --grad_accum_steps 16 \
  --task "mm-reasoning" \
  ...
  "/ytech_m2v5_hdd/workspace/kling_mm/shiyang06/Dataset/abstract_visual/CoM_w_MathVista/filtered_train_w_metadata_9.1_max_seq_len4096.json" \
  ...
  --v5_s1_global_img_tokens 3000 \
  --v5_s1_per_img_tokens 1280