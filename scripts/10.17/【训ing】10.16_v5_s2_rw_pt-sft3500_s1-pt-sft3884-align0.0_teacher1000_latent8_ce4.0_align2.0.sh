...
TEACHER=10.15_v5_s1_rw_pt-sft_gc_latent8_ce4.0_align-wt${TEACHER_ALIGN_WEIGHT}_emph-wt2.0/checkpoint-1000
...
SAVE_CKPT=10.16_v5_s2_rw_pt-sft3500_s1-pt-sft3884_teacher-al${TEACHER_ALIGN_WEIGHT}-1000_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align${ALIGNMENT_WEIGHT}
