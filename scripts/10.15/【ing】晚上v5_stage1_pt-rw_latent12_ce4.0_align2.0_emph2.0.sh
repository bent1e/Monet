...
torchrun --nproc-per-node=8 --master-port=29501 -m src.main \
  ...
  --log_file "./log.txt" \
  --load_model_path /mmu_vcg_ssd/shiyang06-temp/Latent_Think/checkpoint/avt_v5/10.15_v5_s1_rw_pt-sft_gc_latent12_ce4.0_align-wt2.0_emph-wt2.0/checkpoint-500 \
